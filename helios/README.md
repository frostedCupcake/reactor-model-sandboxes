...
A complete, standalone Helios sandbox with separate frontend and backend services.

- `frontend/`: Full React UI, media inputs, session controls, and Helios adapter.
