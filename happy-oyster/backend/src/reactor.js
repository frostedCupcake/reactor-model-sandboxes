export function getReactorModelName(slug, mode) {
  if (slug !== "happy-oyster") return "";
  return mode === "directing" ? "reactor/happy-oyster-director" : "reactor/happy-oyster-adventure";
}
