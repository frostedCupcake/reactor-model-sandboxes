# LingBot World 2 sandbox

A complete, independently runnable recreation of the launchd LingBot World 2 sandbox, with separate frontend and backend services.

- Live reference: [thelaunchd.com/reactor/models/lingbot-world-2](https://thelaunchd.com/reactor/models/lingbot-world-2)
- Reactor documentation: [LingBot World 2 model reference](https://docs.reactor.inc/model-api-reference/lingbot-world-2/overview)
...
cd reactor-model-sandboxes/lingbot-world-2
npm install
```
...
2. Select or upload a required reference image, enter the world prompt, and set rotation speed if needed.
...
7. Use WASD and the arrow keys to move and look around. Pause, resume, or update the prompt from the controls.
...
- **Connecting never becomes Live:** Verify the key can access LingBot World 2, required media is selected, and the backend minted a token for the exact model scope.
